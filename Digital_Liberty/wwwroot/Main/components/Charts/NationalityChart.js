...
export default class NationalityChart extends React.Component {
    constructor() {
        super();
        this.state = {
            nationalityCount: [], loading: true
        };
    }
    ...
    render() {
        const data = this.state.nationalityCount;
        let contents = this.state.loading ? <p><em>Loading...</em></p>
            : NationalityChart.renderChart(data);
